...
namespace AniMedia.API.Tests.ControllerTests.V1.AnimeSeriesControllerTests.AddAnimeSeriesTests; 

public class AddAnimeSeriesTestSuccess : ApiTestBase {
    ...
    public override async Task Test() {
        ...
        var res = await apiClient.ApiV1AnimeSeriesAddAsync(newAnimeSeriesDto);
