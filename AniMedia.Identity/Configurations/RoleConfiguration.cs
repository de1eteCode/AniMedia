...
internal class RoleConfiguration : BaseEntityTypeConfiguration<IdentityRole<Guid>> {
    ...
    public override void Configure(EntityTypeBuilder<IdentityRole<Guid>> builder) {
        builder.HasData(
